                ...
                <AnimatePresence>
                  {servicesOpen ? (
                    <motion.div
                      ...
                      className="absolute left-1/2 top-[calc(100%+0.12rem)] w-[min(94vw,980px)] -translate-x-1/2 overflow-hidden rounded-[32px] border border-violet-100 bg-white/95 p-3 shadow-glow backdrop-blur-2xl dark:border-white/10 dark:bg-slate-950/95"
                    >
