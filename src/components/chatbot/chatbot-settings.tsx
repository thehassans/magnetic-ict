...
export function ChatbotSettings({ userName, userEmail, botName, webhookUrl }: Props) {
  ...
  const inputCls = "w-full rounded-xl border border-gray-200 dark:border-white/[0.08] bg-white dark:bg-white/[0.04] px-3.5 py-2.5 text-sm text-gray-900 dark:text-white outline-none placeholder:text-gray-400 dark:placeholder:text-white/25 focus:border-violet-400 dark:focus:border-violet-500/50 focus:bg-gray-50 dark:focus:bg-white/[0.06] transition";
  const labelCls = "mb-1.5 block text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-white/35";

  return (
    <div className="flex min-h-full">
      {/* Sidebar */}
      <div className="w-56 shrink-0 border-r border-gray-200 dark:border-white/[0.06] bg-gray-50 dark:bg-[#0c0c1d] p-3">
        <p className="mb-2 px-3 text-[10px] font-semibold uppercase tracking-widest text-gray-400 dark:text-white/25">Settings</p>
        {SECTIONS.map((s) => {
          const Icon = s.icon;
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active ? "bg-violet-50 dark:bg-gradient-to-r dark:from-violet-500/20 dark:to-purple-600/5 text-violet-700 dark:text-white" : "text-gray-500 dark:text-white/40 hover:bg-gray-100 dark:hover:bg-white/[0.04] hover:text-gray-700 dark:hover:text-white/70"
              )}
            >
      ...
      <div className="flex min-w-0 flex-1 flex-col p-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">{SECTIONS.find((s) => s.key === section)?.label}</h1>
            <p className="mt-0.5 text-sm text-gray-500 dark:text-white/35">{SECTIONS.find((s) => s.key === section)?.desc}</p>
          </div>
          <button
            type="button"
          ...
          <div className="space-y-6">
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-white/[0.03]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">Account Information</h2>
              </div>
              <div className="space-y-5 p-5">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-white/35">{userEmail}</p>
                  ...
                  <div>
                    ...
                    <select value={profile.timezone} onChange={(e) => setProfile((p) => ({ ...p, timezone: e.target.value }))} className={`${inputCls} cursor-pointer`}>
                      {["UTC", "UTC+1", "UTC+2", "UTC+3", "UTC+4", "UTC+5", "UTC+5:30", "UTC+6", "UTC+7", "UTC+8", "UTC-5", "UTC-8"].map((tz) => (
                        <option key={tz} value={tz} className="dark:bg-[#0e0e22]">{tz}</option>
                      ))}
                    </select>
                  </div>
                </div>
                <div>
                  ...
                  <p className="mt-1.5 text-[11px] text-gray-400 dark:text-white/25">Email address cannot be changed here. Contact support.</p>
                </div>
              </div>
            </div>
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-white/[0.03]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">Workspace</h2>
              </div>
              <div className="divide-y divide-gray-100 dark:divide-white/[0.04]">
                {[
                  ...
                  return (
                    <Link key={link.href} href={link.href} className="flex items-center justify-between px-5 py-3.5 text-sm text-gray-500 dark:text-white/50 transition hover:bg-gray-50 dark:hover:bg-white/[0.02] hover:text-gray-700 dark:hover:text-white/80">
        ...
        {section === "bot" && (
          <div className="space-y-5">
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-white/[0.03]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">AI Agent Defaults</h2>
              </div>
              <div className="space-y-5 p-5">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                  ...
                  <div>
                    ...
                    <select value={bot.responseDelay} onChange={(e) => setBot((b) => ({ ...b, responseDelay: e.target.value }))} className={`${inputCls} cursor-pointer`}>
                      {["0", "1", "2", "3", "5"].map((v) => <option key={v} value={v} className="dark:bg-[#0e0e22]">{v === "0" ? "Instant" : `${v}s`}</option>)}
                    </select>
                  </div>
                </div>
                <div>
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-[#0c0c1d]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">Routing & Automation</h2>
              </div>
              <div className="divide-y divide-gray-100 dark:divide-white/[0.04]">
                {[
                  ...
                  <div key={item.key} className="flex items-center justify-between px-5 py-4">
                    <div>
                      <p className="text-sm font-medium text-gray-700 dark:text-white/80">{item.label}</p>
                    ...
                    <button type="button" onClick={() => setBot((b) => ({ ...b, [item.key]: !b[item.key] }))}
                      className={cn("relative inline-flex h-6 w-11 shrink-0 rounded-full transition-colors", bot[item.key] ? "bg-violet-600 shadow-[0_0_10px_rgba(124,58,237,0.4)]" : "bg-gray-200 dark:bg-white/10")}>
        ...
        {section === "notifications" && (
          <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-[#0c0c1d]">
            <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
              <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">Notification Preferences</h2>
            </div>
            <div className="divide-y divide-gray-100 dark:divide-white/[0.04]">
              {[
                ...
                <div key={item.key} className="flex items-center justify-between px-5 py-4">
                  ...
                  <button type="button" onClick={() => setNotifs((n) => ({ ...n, [item.key]: !n[item.key] }))}
                    className={cn("relative inline-flex h-6 w-11 shrink-0 rounded-full transition-colors", notifs[item.key] ? "bg-violet-600 shadow-[0_0_10px_rgba(124,58,237,0.4)]" : "bg-gray-200 dark:bg-white/10")}>
        ...
        {section === "appearance" && (
          <div className="space-y-5">
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-[#0c0c1d]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">Theme</h2>
              </div>
              <div className="space-y-5 p-5">
                <div>
                  ...
                  <div className="mt-2 flex gap-3">
                    {[
                      ...
                      <button key={c.key} type="button" onClick={() => setAppearance((a) => ({ ...a, accentColor: c.key }))}
                        className={cn("h-8 w-8 rounded-full transition", c.bg, appearance.accentColor === c.key ? `${c.shadow} ring-2 ring-white/30 ring-offset-2 ring-offset-white dark:ring-offset-[#0c0c1d]` : "opacity-50 hover:opacity-80")} />
                    ))}
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-700 dark:text-white/80">Compact mode</p>
                    <p className="text-xs text-gray-400 dark:text-white/30">Reduce spacing for a denser layout</p>
                  </div>
                  <button type="button" onClick={() => setAppearance((a) => ({ ...a, compactMode: !a.compactMode }))}
                    className={cn("relative inline-flex h-6 w-11 shrink-0 rounded-full transition-colors", appearance.compactMode ? "bg-violet-600 shadow-[0_0_10px_rgba(124,58,237,0.4)]" : "bg-gray-200 dark:bg-white/10")}>
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-gray-50 dark:bg-[#0c0c1d] p-5">
              <Moon className="h-5 w-5 text-violet-500 dark:text-violet-400 shrink-0" />
              <div>
                <p className="text-sm font-medium text-gray-700 dark:text-white/80">Theme follows system toggle</p>
                <p className="text-xs text-gray-500 dark:text-white/30">Use the dark mode toggle in the sidebar to switch between light and dark theme.</p>
              </div>
            </div>
          </div>
        )}
        ...
        {section === "security" && (
          <div className="space-y-5">
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-[#0c0c1d]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">Active Sessions</h2>
              </div>
              <div className="p-5">
                <div className="flex items-start justify-between rounded-xl border border-gray-200 dark:border-white/[0.07] bg-gray-50 dark:bg-[#0c0c1d] p-4">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-50 dark:bg-emerald-500/15">
                      <Shield className="h-4 w-4 text-emerald-600 dark:text-emerald-300" />
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-700 dark:text-white/80">Current session</p>
                      <p className="text-xs text-gray-400 dark:text-white/30">Active now · {userEmail}</p>
                    </div>
                  </div>
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-white/[0.03]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">Access Control</h2>
              </div>
              <div className="divide-y divide-gray-100 dark:divide-white/[0.04]">
                {[
                  ...
                  <div key={row.label} className="flex items-center justify-between px-5 py-4">
                    <div>
                      <p className="text-sm font-medium text-gray-700 dark:text-white/80">{row.label}</p>
                      <p className="text-xs text-gray-400 dark:text-white/30">{row.value}</p>
                    </div>
        ...
        {section === "api" && (
          <div className="space-y-5">
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-white/[0.03]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">Webhook Endpoint</h2>
              </div>
              <div className="p-5 space-y-4">
                <div>
                  ...
                  <p className="mt-1.5 text-[11px] text-gray-400 dark:text-white/25">This URL receives all incoming messages from Meta platforms.</p>
                </div>
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/[0.07] bg-white dark:bg-white/[0.03]">
              <div className="border-b border-gray-200 dark:border-white/[0.06] px-5 py-4">
                <h2 className="text-sm font-semibold text-gray-700 dark:text-white/80">API Keys</h2>
              </div>
              <div className="p-5">
                <div className="flex flex-col items-center gap-3 py-8 text-center">
                  <Key className="h-8 w-8 text-gray-200 dark:text-white/10" />
                  <p className="text-sm text-gray-400 dark:text-white/30">API key management is available in the admin panel.</p>
