...
export function AuthPage({
  ...
  function handleOtpChange(index: number, event: ChangeEvent<HTMLInputElement>) {
    // When a box already has a digit and user types a new one, browsers append it
    // producing a 2-char value. Strip the existing digit so only the new char is processed.
